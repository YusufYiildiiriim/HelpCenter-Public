...
export const RoleHeader: React.FC<RoleHeaderProps> = ({ onAddClick, canCreate }) => {
  return (
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="mt-1 text-xs sm:text-sm font-medium text-slate-300 max-w-xl">
              Sistemdeki rollerin modül erişim yetkilerini ve veri kapsamı sınırlarını belirleyin.
            </p>
          </div>
        </div>
